...
public final class TestTokenizer extends Tokenizer {

	private static Logger logger = Loggers.getLogger(TestTokenizer.class, "");
	...
	public TestTokenizer(ProductNameDictionary dictionary) {
		if (dictionary != null) {
	...
	public TestTokenizer(AttributeFactory factory) {
		super(factory);
	}
