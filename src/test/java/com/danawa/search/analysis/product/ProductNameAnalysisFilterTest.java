...
// 		TagProbDictionary dictionary = TestUtil.loadBaseDictionary();
// 		{
// 			file = TestUtil.getFileByProperty(key)

// 			dictionary = new TagProbDictionary(file, true);
// 		}

// 			File probDictionarySourceFile = new File(dictionaryDir, "0.lnpr_morp.txt");
// 			File probDictionarySourceFile2 = new File(dictionaryDir, "words-prob.txt");
// 			PosTag[] usableTags = new PosTag[] { PosTag.N };
// 			File[] dictionarySourceList = new File[] {
// //				, new File("dictionary/source/00.N.MID.txt")
// 				new File("dictionary/source/01.N.P11.txt")
// 				, new File("dictionary/source/02.N.MIN.txt")
// 				, new File("dictionary/source/03.N.LOW.txt")
// 			};
			
// 			File userFile = new File(dictionaryDir, "09.User.txt");
// 			File synonymFile = new File(dictionaryDir, "10.Synonym.txt");
// 			File stopFile = new File(dictionaryDir, "11.Stop.txt");
			
// 			ProductTagProbDictionaryBuilder builder = new ProductTagProbDictionaryBuilder(probDictionarySourceFile, probDictionarySourceFile2, usableTags,
